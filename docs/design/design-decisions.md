...
## 9. Mermaid for diagrams, not draw.io

**Decision:** Use Mermaid (text-based) for all system diagrams.

**Rationale:**
- Renders natively on GitHub — no export/conversion step
- Version-controlled as text (meaningful diffs)
- Supports colours, styling, sequence diagrams
- Good enough for architecture and flow diagrams
- draw.io reserved for if we ever need embedded graphics or physical layout diagrams
